Final.cpp instruction manual:

Enter a desired ASCII character to represent the shape's body,
followed by an integer representing the shape's size. 

Upon initialization the shape will appear once interacted with via controls.
